...
public class EvenementaddController implements Initializable {
    ...
    @FXML
    private Button transport11;
    @FXML
    private Button transport111;
    @FXML
    private Button transport1111;
    @FXML
    private Button transport11111;
    @FXML
    private Button transport111111;
    @FXML
    private Button transport1111111;
    @FXML
    private Button transport11111111;
    @FXML
    private Button transport111111111;
    @FXML
    private Button transport1111111111;
    @FXML
    private Button transport11111111111;
    @FXML
    private Button transport111111111111;
    @FXML
    private Button transport1111111111111;
    @FXML
    ...
    private void add(ActionEvent event) throws SQLException, WriterException, IOException {
       ...
       String datef=DF.getValue().format(DateTimeFormatter.ofPattern("yyyy-MM-dd"));
         ...
         rs7=cnx.createStatement().executeQuery("SELECT id_hebergement FROM hebergement where ville='"+k+"'");
         rs7.next();
         int id2=rs7.getInt("id_hebergement");
         rs8=cnx.createStatement().executeQuery("SELECT id_equipement FROM equipement where nom='"+j+"'");
         rs8.next();
         int id3=rs8.getInt("id_equipement");
    ...
    EQ.setValue(equip.getCellData(index).toString()); 
         ...
         rs7=cnx.createStatement().executeQuery("SELECT ville FROM hebergement where id_hebergement='"+hb.getValue()+"'");
         rs7.next();
         String id2=rs7.getString("ville");
         rs8=cnx.createStatement().executeQuery("SELECT nom FROM equipement where id_equipement='"+EQ.getValue()+"'");
         rs8.next();
   ...
   DF.setValue(LocalDate.now());
    ...
    @FXML
    private void traiterrec(MouseEvent event) {
         try {
    ...
    @FXML
    private void reclamerrr(MouseEvent event) {
          try {
